...
public class LMONKEY_PRODUCTDao {
	...
	public static int insert(LMONKEY_PRODUCT p) {
		String sql = "insert into hogenshop_PRODUCT values(null, ?, ?,?,?,?,?,?)";
	...
	public static ArrayList<LMONKEY_PRODUCT> selectAll() {
		...
		try {
			String sql = "select * from hogenshop_PRODUCT";
	...
	public static LMONKEY_PRODUCT selectById(int id) {
		...
		try {
			String sql = "select * from hogenshop_PRODUCT where PRODUCT_ID=?";
			ps = conn.prepareStatement(sql);
			ps.setInt(1, id);
			rs = ps.executeQuery();
	...
	public static ArrayList<LMONKEY_PRODUCT> selectAllByFid(int fid) {
		...
		try {
			String sql = "select * from hogenshop_PRODUCT where PRODUCT_FID=?";
			ps = conn.prepareStatement(sql);
			ps.setInt(1, fid);
			rs = ps.executeQuery();
	...
	public static ArrayList<LMONKEY_PRODUCT> selectAllByCid(int cid) {
		...
		try {
			String sql = "select * from hogenshop_PRODUCT where PRODUCT_CID=?";
			ps = conn.prepareStatement(sql);
			ps.setInt(1, cid);
			rs = ps.executeQuery();
